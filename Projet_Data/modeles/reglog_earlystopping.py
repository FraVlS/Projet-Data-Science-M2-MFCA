...
def build_logistic_regression(X, learning_rate=0.001):
    ...
    optimizer = tf.keras.optimizers.legacy.Adam(learning_rate=learning_rate)#si vous avez une version récente de Keras il faut utiliser tf.keras.optimizers.Adam
...
#print(f"Résultats sur le test set - Loss: {eval_results[0]:.4f}, Accuracy: {eval_results[1]:.4f}")


#save_dir = "/Users/timothee/Documents/Université Lille/M2/Data Sciences/Projet"
#os.makedirs(save_dir, exist_ok=True)
#model_path = os.path.join(save_dir, "final_logistic_regression_model.h5")
#model.save(model_path)
#print("\nModèle sauvegardé sous 'final_logistic_regression_model.h5")
model = keras.models.load_model("/Users/timothee/Documents/Université Lille/M2/Data Sciences/Projet/Logit_model.h5")
...
results = []
results.append(evaluate_and_export_model(y_test, y_proba, "Reglog.early-stop", override='Yes'))
