...
results = []
results.append(evaluate_and_export_model(y_test, baseline_y_proba, "Logit_Baseline", override='Yes'))
results.append(evaluate_and_export_model(y_test, NM_y_proba, "Logit_NearMiss", override='Yes'))
results.append(evaluate_and_export_model(y_test, smote_y_proba, "Logit_SMOTE", override='Yes'))